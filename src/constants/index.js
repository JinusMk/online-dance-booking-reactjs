...
export const reviewsData = [
  {
    ...
    rating: '4',
    media: '',
    description: 'I have been attending Zumba for couple of years, I came across this site for online Zumba. The instructor was good, the session was peppy and a good workout.',
  ...
  },
  {
    ...
    rating: '5',
    media: '',
    description: 'The Zumba session was fab… awesome energy and super workout. The instructor guided us with the steps and checked if we are doing it right.. thank u..',
  ...
  },
  {
    ...
    rating: '4',
    media: '',
    description: 'This is the first time I am attending Zumba, when the session started I was feeling it’s high intensity but eventually when I took few breaks for a min and continued i had so much fun and its helping me in my weight loss. can’t wait for my next session.',
  ...
  },
  {
    ...
    rating: '5',
    media: '',
    description: 'The instructor gave clear step by step instruction and made it super easy to learn. I thought I had a left feet but the first class gave me an enormous confidence.',
  ...
  },
  {
    ...
    rating: '5',
    media: '',
    description: 'Loved the way how every part of choreography was easily broken down to easy simple steps. I am super happy that I am able to dance to my favourite song now! Thank you!',
  ...
  },
  {
    ...
    rating: '5',
    media: '',
    description: 'I had a very good online Bollywood class with Manas, can’t wait for my next..',
  ...
  },
  {
    ...
    rating: '4',
    media: '',
    description: 'Loved the hiphop class, awesome instructor. I would like to join the regular sessions and learn hiphop. thank you.',
  ...
  },
  {
    ...
    rating: '5',
    media: '',
    description: 'I booked the class for my son who has a passion to dance but gets bored very quickly, I found this class more convenient as its online from home. my son seems to be interested as they introduce new steps and style in every class.',
  ...
  },
  {
    ...
    rating: '5',
    media: '',
    description: 'This is the first time I am trying an online Hiphop session, I never thought it would be so much fun! The instructor was so patient and he taught every step until everyone got it right. Its rare to find someone so patient and motivating. Thanks for a wonderful session…',
  ...
  },
  {
    ...
    rating: '5',
    media: '',
    description: 'Great option to keep the kids active and learn dancing from home. Its very convenient no worry of being late or traffic! She is enjoying every class.. Looking forward to more classes.',
    class_date: '17-09-2020',
  ...
  },
  {
    ...
    rating: '4',
    media: '',
    description: 'Very nice concept, my daughter enjoyed the class… very convenient. The instructor is very good and polite. Thank you.',
  ...
  },
  {
    ...
    rating: '5',
    media: '',
    description: 'I never though I can make my kid be attentive for an online class as he is always running around but you guys proved me wrong. He stayed the whole time during the online dance session and he thoroughly enjoyed. Thank you.',
