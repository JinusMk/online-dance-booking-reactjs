...
export default function UserSubscriptionOverview(props){
    ...
    return(
        <Grid item xs={12} className="user-subscription-list-item">
            ...
            <div className="user-subscription-overview">
                ...
                <Grid className="overview-info" container spacing={2}>
                    <Grid item xs={4}>
                ...
                <Grid container>
                    <Grid item xs={12}>
                        <div className="bottom-blk">
                            ...
                            <p><Link to="/user-subscription/progress" className="primaryBtn">SEE MY PROGRESS</Link></p>
                        </div>
                    </Grid>
                </Grid>
            </div>
