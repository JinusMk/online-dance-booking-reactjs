    ...
    const handleInviteClick = () => {
        ...
        if (navigator.share) {
            navigator.share({
              ...
              url: type == "danceBooking" ? `https://letzdance.co/dance/${params.category}/${params.id}/booking` : type == "subscription" ? `https://letzdance.co/subscription/${params.category}/${params.categoryId}` : `https://letzdance.co/`
            })
